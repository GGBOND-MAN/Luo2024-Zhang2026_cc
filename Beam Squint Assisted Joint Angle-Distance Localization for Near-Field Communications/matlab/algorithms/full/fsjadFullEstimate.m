function result = fsjadFullEstimate( ...
    cfg, observation, snapshots, carrierIndex, scan, algorithm)
%FSJADFULLESTIMATE Run the frozen full-complexity localization pipeline.
...
arguments
    ...
    algorithm (1, 1) struct = fsjadFullConfig()
end
...
if numel(observation) ~= cfg.numSubcarriers
    error("fsjadFull:ObservationSize", ...
