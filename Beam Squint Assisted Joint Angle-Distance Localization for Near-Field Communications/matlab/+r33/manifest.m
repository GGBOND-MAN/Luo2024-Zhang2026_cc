...
%MANIFEST Hash R33 sources and inherited executable dependencies.

arguments
    project (1, 1) string
end

folders = ["+r33", "+r32", "+r31", "+r30", "+r29", "+fsjad", "+jad"];
paths = strings(0, 1);
for folder = folders
    listing = dir(fullfile(project, folder, "**", "*.m"));
    paths = appendListing(paths, listing, project);
end
listing = [dir(fullfile(project, "experiments", "*round33*.m")); ...
